...
const fetchCohereResponse = async (userPrompt, lang) => {
  ...
  try {
    const messages = [
      {
        ...
        content: `You are InspireBot, an AI assistant designed to empower rural entrepreneurs. 
                  ...
                  access government schemes, and connect with local marketplaces. 
                  Respond in a friendly and supportive tone, ensuring clarity and simplicity for users of all backgrounds.
                  Always reply in the user's selected language (${LANGUAGES.find(l => l.code === lang)?.label || "English"}).`,
      },
      ...conversation,
    ...
    setConversation((prev) => [
      ...prev,
      { role: "user", content: userPrompt },
      { role: "system", content: result || "No response from InspireBot." },
    ]);
  ...
  return (
    <>
      ...
      <div style={{ display: "flex", minHeight: "100vh", alignItems: "center", position: "relative" }}>
        ...
        <div className="min-vh-100" style={{ zIndex: 1, position: "relative", flex: 1 }}>
